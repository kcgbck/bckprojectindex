...
const LAW_LIST = [
    ...
    { no: 73, name: "마리나항만의 조성 및 관리 등에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=011016&type=JSON" },
    { no: 74, name: "마리나항만의 조성 및 관리 등에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=011115&type=JSON" },
    { no: 75, name: "마리나항만의 조성 및 관리 등에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=011114&type=JSON" },
    { no: 73, name: "항만법", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=001737&type=JSON" },
    { no: 74, name: "항만법 시행령", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=005528&type=JSON" },
    { no: 75, name: "항만법 시행규칙", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=008651&type=JSON" },
    { no: 73, name: "자연유산의 보존 및 활용에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=014410&type=JSON" },
    { no: 74, name: "자연유산의 보존 및 활용에 관한 법률 시행령", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=014653&type=JSON" },
    { no: 75, name: "자연유산의 보존 및 활용에 관한 법률 시행규칙", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=admrul&ID=014669&type=JSON" },
];
