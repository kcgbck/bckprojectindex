...
const LAW_LIST = [
    ...
    { no: 74, name: "마리나항만의 조성 및 관리 등에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=eflaw&ID=011115&type=JSON" },
    { no: 75, name: "마리나항만의 조성 및 관리 등에 관한 법률", api: "http://www.law.go.kr/DRF/lawService.do?OC=bck&target=eflaw&ID=011114&type=JSON" },
